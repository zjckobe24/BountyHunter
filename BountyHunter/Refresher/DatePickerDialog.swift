...
class DatePickerDialog: UIView {
    ...
    func show(title title: String, datePickerMode: UIDatePickerMode = .Date, callback: ((date: NSDate) -> Void)) {
    ...
    func show(title title: String, doneButtonTitle: String, cancelButtonTitle: String, defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .Date, callback: ((date: NSDate) -> Void)) {
